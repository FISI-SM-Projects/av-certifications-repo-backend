...
import pe.edu.unmsm.fisi.gestiondocente.constancia.web.dto.SemesterCertificateSource;
...
import pe.edu.unmsm.fisi.gestiondocente.constancia.web.dto.request.ExpectedCourseRequest;
import pe.edu.unmsm.fisi.gestiondocente.constancia.web.dto.request.SemesterCertificateRequest;
import pe.edu.unmsm.fisi.gestiondocente.constancia.web.dto.response.SemesterCertificateResponse;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.CertificateGenerationMetadata;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.EstadoConstancia;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.TipoConstancia;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.ApprovedCertificateAlreadyExistsException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.CertificateSourceInconsistencyException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.MissingExpectedCoursesException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.TeacherNotFoundForCertificateException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.port.PdfGenerationService;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.port.CertificateGenerationRepository;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.validation.CertificateRequestNormalizer;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.validation.CourseCertificateRequestNormalizer;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.validation.SemesterCertificateRequestNormalizer;
import pe.edu.unmsm.fisi.gestiondocente.constancia.application.validation.SemesterCertificateRequestValidator;
