package pe.edu.unmsm.fisi.gestiondocente.constancia.web;
...
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.DuplicateExpectedCoursesException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.GenerationAlreadyExistsException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.InvalidPdfContentException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.InvalidStoragePathException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.InvalidRequestFieldsException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.MissingExpectedCoursesException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.MissingRequiredFieldsException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.PdfGenerationException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.StorageException;
import pe.edu.unmsm.fisi.gestiondocente.constancia.domain.exception.TeacherIdentityMismatchException;
